...
public class Main {
                ...
                try{
                    ...
                    switch (task){
                        ...
                        case 2:
                            ...
                            Task2.save(fileName);
                            LinkedList<Sportsman> sportsmen = Task2.load(fileName);//"Task2.txt"
                            System.out.println("Список жителей после выполнения первой части задания: ");
                            for(Sportsman sportsman: sportsmen){
                                System.out.println(sportsman.getSurname() + " " + sportsman.getName() + " ростом " + sportsman.getHeight());
                            }
                            sportsmen = Task2.randomAccess(sportsmen);
                            System.out.println("Список жителей после выполнения второй части задания: ");
                            for(Sportsman sportsman: sportsmen){
                                System.out.println(sportsman.getSurname() + " " + sportsman.getName() + " занимается " + sportsman.getType());
                            }
                            break;
                        case 3:
    ...
    private static void task1(){
        try {
            ...
            dir1.mkdir();
            File dir2 = new File("D:\\Vanish\\ООП Java\\Money\\Алиса Бабух\\Laba4");
    ...
    private static void task3Ex3(){
        try {
            BufferedReader in = new BufferedReader(new InputStreamReader(new FileInputStream("D:\\Vanish\\ООП Java\\Money\\Алиса Бабух\\Laba4\\src\\A.txt"), "Cp1251"));
            ...
            in = new BufferedReader(new InputStreamReader(new FileInputStream("D:\\Vanish\\ООП Java\\Money\\Алиса Бабух\\Laba4\\src\\B.txt"), "UTF-8"));
            str = in.readLine();
            ...
            try {
                ...
                switch (ex) {
                    ...
                    case 2:
                        ...
                        System.out.println("Введите текст для записи в объект:");
                        object.dataStream(in.nextLine());
                        System.out.println("Текст объкта:\n" + object.getObject().getText());
                        break;
                    case 3:
                        System.out.println("Введите имя файла");
                        ClassSeriyazableFile sObj = new ClassSeriyazableFile(in.nextLine());
                        sObj.majeCollection();
                        sObj.readCollection();
                        ArrayList<ClassFrom2Laba> arr = sObj.getCollection();
                        System.out.println("Десериализованная коллекция объектов:");
                        for(ClassFrom2Laba str: arr)
