...
//Сформировать строку из ключевых слов языка, которые используются в тексте.
    public void showEntrys(){
        ...
        System.out.print("Ключевые слова, встречающиеся в тексте: ");
        while (it.hasNext()){
            System.out.print(" " + it.next());
        }
        System.out.println();
    }
//Первые строчные символы в словах сформированного массива заменить прописными.
    public void toUpper(){
        if(text == ""){
            System.out.println("Инициализация не произведена."); return;
        }
        ...
        Iterator<String> it = words.iterator();
        System.out.print("Ключевые слова, встречающиеся в тексте с заглавной буквы: ");
        while (it.hasNext()){
            String word = it.next();
...
//Сформировать массив, который хранит количество вхождений каждого ключевого слова в код программы.
    public void countEntrys(){
        ...
        System.out.print("Ключевые слова, встречающиеся в тексте и количество их вхождений: ");
        for(String key: keysIn)
            System.out.print(" " + key + " - " + count.get(key) + ",");
        System.out.println();
    }
//Сформировать строку из пользовательских идентификаторов.
